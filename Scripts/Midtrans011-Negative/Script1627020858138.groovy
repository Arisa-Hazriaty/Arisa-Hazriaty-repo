...
WebUI.setText(findTestObject('txt-cardnumber'), GlobalVariable.ccinvalid)
...
WebUI.verifyElementText(findTestObject('txt-invalid-card-number'), 'Invalid card number')

WebUI.setText(findTestObject('txt-cardnumber'), GlobalVariable.cardnumber)

WebUI.setText(findTestObject('txt-expiry-date'), GlobalVariable.expiryinvalid)
